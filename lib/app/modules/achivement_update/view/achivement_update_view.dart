...
class AchimenetUpdateView extends StatelessWidget {
  final AchivementUpdateController controller =
      Get.find<AchivementUpdateController>();
  AchimenetUpdateView({Key? key}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15),
                        GetBuilder(
                            init: controller, builder: (_) => inputImage()),
                        SizedBox(
                          height: 15,
                        ),
                        Container(
